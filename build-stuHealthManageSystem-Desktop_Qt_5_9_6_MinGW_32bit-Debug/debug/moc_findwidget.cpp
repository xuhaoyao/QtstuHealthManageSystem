...
#include "../../stuHealthManageSystem/findwidget.h"
...
QT_MOC_LITERAL(5, 51, 21) // "on_findButton_clicked"

    },
    "findWidget\0display\0\0number\0"
    "on_returnButton_clicked\0on_findButton_clicked"
};
...
void findWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (findWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&findWidget::display)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void findWidget::display(int _t1)
{
