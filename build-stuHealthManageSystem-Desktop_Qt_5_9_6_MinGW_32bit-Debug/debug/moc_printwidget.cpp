...
#include "../../stuHealthManageSystem/printwidget.h"
...
QT_MOC_LITERAL(5, 52, 21) // "on_showButton_clicked"

    },
    "printWidget\0display\0\0number\0"
    "on_returnButton_clicked\0on_showButton_clicked"
};
...
void printWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (printWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&printWidget::display)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject printWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_printWidget.data,
      qt_meta_data_printWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void printWidget::display(int _t1)
{
